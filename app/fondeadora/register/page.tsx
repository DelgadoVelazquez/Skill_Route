    ...
    <main style={styles.page}>
      <div style={styles.card}>
        ...
        <div style={styles.header}>
          ...
          <h1 style={styles.title}>Registrar fondeadora</h1>
          <p style={styles.subtitle}>Publica programas y financia talento educativo</p>
        </div>
        ...
        <div style={styles.body}>
          <form onSubmit={handleRegister} style={styles.form}>
            ...
            {[
              ...
              { label: 'CORREO ORGANIZACIONAL',      value: email,    set: setEmail,    type: 'email',    ph: 'contacto@fondeadora.org' },
            ...
            <button type="submit" disabled={loading} style={styles.btn}>
              {loading ? 'Creando cuenta...' : 'Registrar fondeadora'}
            </button>

            <div style={styles.links}>
              <Link href="/fondeadora/login" style={styles.link}>
