    ...
    <main className="claim-page">
      <div className="claim-wrapper">
        <div className="claim-top">
          <div className="claim-pill">• EVENTO EN VIVO · SUMMIT IA MÉXICO 2026</div>

          <div className="claim-badge-circle">
            <div className="claim-badge-emoji">🤖</div>
            <span className="claim-badge-text">IA BADGE</span>
          </div>
        </div>

        <section className="claim-hero">
          <h1 className="claim-title">Pionero en Inteligencia Artificial</h1>

          <p className="claim-meta">
            Emitido por <strong>TechSummit México</strong> · 13 Mar 2026
          </p>
